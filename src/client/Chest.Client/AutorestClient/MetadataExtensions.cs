...
namespace Chest.Client.AutorestClient
{
    ...
    public static partial class MetadataExtensions
    {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<IDictionary<string, MetadataModel>> GetDataByKeysAsync(this IMetadata operations, string category, string collection, IList<string> keys = default(IList<string>), string keyword = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.GetDataByKeysWithHttpMessagesAsync(category, collection, keys, keyword, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
